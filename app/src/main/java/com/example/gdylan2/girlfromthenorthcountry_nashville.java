...
public class girlfromthenorthcountry_nashville extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_girlfromthenorthcountry_nashville);
