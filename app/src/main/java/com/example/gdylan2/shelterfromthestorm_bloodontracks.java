...
public class shelterfromthestorm_bloodontracks extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shelterfromthestorm_bloodontracks);
