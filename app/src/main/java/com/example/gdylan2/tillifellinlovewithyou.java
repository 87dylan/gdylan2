...
public class tillifellinlovewithyou extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tillifellinlovewithyou);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        Log.d("Tag", "onCheckedChanged: "+className);
        if(isChecked){
